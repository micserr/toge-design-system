...
<div class="spr-flex spr-flex-col spr-gap-6"> 
  ...
  <spr-filter 
    ...
    :filterData="filterMenuOptions"
    @selectedFilter="(e) => console.log('DEBIG', e)"
    filterable
  />
</div>
...
const options = [
    ...
    { column: '', isSelected: false, text: 'sample 3', subtext: '', value: 'sample3' },
    ...
    { column: '', isSelected: false, text: 'sample 6', subtext: 'subtext', value: 'sample6' },
    { column: '', isSelected: false, text: 'sample 7', subtext: 'subtext', value: 'sample7' },
    { column: '', isSelected: false, text: 'sample 8', subtext: 'subtext', value: 'sample8' },
    { column: '', isSelected: false, text: 'sample 9', subtext: 'subtext', value: 'sample9' },
];
  ...
  const filterMenuOptions = [
    ...
    { column: 'location', isSelected: false, text: 'sample 6', subtext: 'subtext', value: 'sample6' },
    { column: 'location', isSelected: false, text: 'sample 7', subtext: 'subtext', value: 'sample7' },
    { column: 'location', isSelected: false, text: 'sample 8', subtext: 'subtext', value: 'sample8' },
    { column: 'location', isSelected: false, text: 'sample 9', subtext: 'subtext', value: 'sample9' },
];
