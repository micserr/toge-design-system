<template>
  <div
    ...
    :class="[
      ...
      { 'spr-cursor-not-allowed spr-opacity-50': props.disabled },
    ]"
    role="slider"
  ...
  >
    ...
    <Icon
      ...
      :class="[
        ...
        'spr-absolute spr-top-1/2 spr--translate-x-1/2 spr--translate-y-1/2 spr-transform spr-rounded-full spr-text-kangkong-600 hover:spr-text-kangkong-700',
...
const { sliderRef, handleSliderSize, handleSliderThumbSize, startDrag,handleSliderStyle, handleThumbStyle } = useSlider(
  props,
  emit,
);
</script>
