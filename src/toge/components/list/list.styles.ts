...
export function getListClasses() {
  return {
    wrapper: classNames('spr-flex spr-flex-col spr-overflow-y-auto'),
    inner: classNames('spr-p-size-spacing-3xs spr-grid spr-gap-[2px]'),
    searchWrapper: classNames(
      'spr-px-size-spacing-xs spr-py-size-spacing-2xs spr-border-b spr-border-color-weak',
    ),
