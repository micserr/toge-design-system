...
The select component fully supports arrays of number values in multi-select mode.
...
```vue
<template>
  <spr-select id="direct-number-select" v-model="selectedYears" :menu-list="yearOptions" multi-select>
