...
```vue
<template>
  <SprCheckbox v-model="checkbox" label="Checkbox Label" bordered />
</template>
...
```vue
<template>
  <SprCheckbox v-model="checkbox" label="Checkbox Label" bordered disabled />
</template>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>bordered</td>
      <td>if `true`, the component design will be changed to bordered</td>
      <td>boolean</td>
      <td>false</td>
    </tr>
  </tbody>
