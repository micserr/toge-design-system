...
<spr-date-range-picker id="dateRange1" v-model="dateRangeModel.range1" display-helper />
...
<spr-date-range-picker id="inputSample" v-model="liveInputRange" label="Pay Period">
...
<spr-date-range-picker id="chipsSample" v-model="liveChipsRange" label="Pay Period">
  <template #default="{ handleClick }">
    <div class="spr-flex spr-gap-2 spr-items-center spr-p-2 spr-border">
      <spr-chips tone="info" :label="liveChipsRange.startDate || 'Start'" @click="handleClick"/>
      <span class="spr-text-mushroom-500">to</span>
      <spr-chips tone="info" :label="liveChipsRange.endDate || 'End'" @click="handleClick"/>
    </div>
  </template>
</spr-date-range-picker>
...
<spr-date-range-picker id="dateRange2" v-model="dateRangeModel.range2" label="Date Range" display-helper format="YYYY-MM-DD" />
...
<spr-date-range-picker id="dateRange3" v-model="dateRangeModel.range3" label="Date Range" width="400px" display-helper />
...
<spr-date-range-picker id="dateRange4" v-model="dateRangeModel.range4" label="Date Range" display-helper format="YYYY-MM-DD" />
...
<spr-date-range-picker id="dateRange5" v-model="dateRangeModel.range5" label="Date Range" display-helper disabled />
...
<spr-date-range-picker id="dateRange6" v-model="dateRangeModel.range6" label="Date Range" display-helper readonly />
...
<spr-date-range-picker id="dateRange7" v-model="dateRangeModel.range7" label="Date Range" helper-text="Select a date range" display-helper />
...
<spr-date-range-picker id="dateRange8" v-model="dateRangeModel.range8" label="Date Range" helper-icon="ph:warning-circle-fill" helper-text="This is a helper message" display-helper error />
...
<spr-date-range-picker id="dateRange9" v-model="dateRangeModel.range9" label="Date Range" :min-max-year="{ min: 2000, max: 2025 }" display-helper />
...
<spr-date-range-picker id="dateRange10" v-model="dateRangeModel.range10" label="Date Range" :rest-days="['mo', 'we', 'fr', 'sa']" display-helper />
...
<spr-date-range-picker id="defaultTopPlacement" v-model="dateRangeModel.defaultTop" label="Top Placement" placement="top" display-helper />
...
<spr-date-range-picker id="dateRange11" v-model="dateRangeModel.range11" label="Date Range" :disabled-dates="{ from: '02-12-2025', to: '05-15-2025' }" display-helper />
...
<spr-date-range-picker id="dateRange12" v-model="dateRangeModel.range12" label="Date Range" display-helper />
