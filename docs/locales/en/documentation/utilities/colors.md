---
title: Colors
description: Overview of the color scheme used in the design system, including primary colors and their variants.
outline: deep
---
...
For **semantic design color tokens** (text, background, border, divide) that map to these palettes for UI states, see [Color Tokens](/en/documentation/utilities/color-tokens). The tokens are defined in `src/assets/styles/tailwind.css`.
...
The Toge Design System v3.0 - Color Scheme includes the following palettes. Use the pattern `spr-{property}-{palette}-{shade}` (e.g. `spr-bg-white-50`, `spr-text-kangkong-700`).
