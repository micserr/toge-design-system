...
export interface SelectLadderizedStyleProps {
  disabled?: boolean
  error?: boolean
  active?: boolean
  focused?: boolean
...
export function getSelectLadderizedClasses(p: SelectLadderizedStyleProps) {
  return {
    ...
    triggerTextSelected: classNames(
      'spr-flex-1 spr-truncate spr-body-md-regular spr-text-left spr-text-color-strong',
      {
        'spr-text-color-on-fill-disabled': p.disabled,
      },
    ),
    ...
    backButton: classNames(
      'spr-flex spr-items-center spr-gap-size-spacing-xs spr-px-size-spacing-sm spr-py-size-spacing-xs spr-cursor-pointer spr-body-sm-semibold spr-text-color-brand-base spr-border-b spr-border-color-weak hover:spr-bg-color-hover-weak spr-w-full',
    ),

    optionItem: classNames(
      'spr-flex spr-items-center spr-justify-between spr-gap-size-spacing-xs spr-px-size-spacing-sm spr-py-size-spacing-xs spr-cursor-pointer spr-body-md-regular spr-text-color-strong hover:spr-bg-color-hover-weak',
    ),

    optionItemDisabled: classNames(
      'spr-flex spr-items-center spr-justify-between spr-gap-size-spacing-xs spr-px-size-spacing-sm spr-py-size-spacing-xs spr-cursor-not-allowed spr-body-md-regular spr-text-color-on-fill-disabled',
    ),

    optionItemSelected: classNames(
      'spr-flex spr-items-center spr-justify-between spr-gap-size-spacing-xs spr-px-size-spacing-sm spr-py-size-spacing-xs spr-cursor-pointer spr-body-md-regular spr-text-color-strong spr-bg-color-selected-weak hover:spr-bg-color-hover-weak',
    ),

    optionItemText: classNames('spr-flex-1 spr-truncate'),

    optionItemTrailing: classNames('spr-flex spr-items-center spr-gap-1 spr-shrink-0 spr-text-color-supporting'),
